...
public class BatteryView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setStyle(Style.STROKE);//轻描
...
//		int h_top = battery_top + battery_height / 3 - battery_head_height / 3;
		int h_top = battery_top + battery_height / 3 ;
		int h_right = h_left + battery_head_width;
//		int h_bottom = h_top + battery_head_height;
		int h_bottom = h_top + battery_head_height / 3;
